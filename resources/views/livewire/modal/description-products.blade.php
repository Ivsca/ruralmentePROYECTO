...
<div>
    <button wire:click="set('open', true)"
        class="select-none rounded-lg bg-blue-500 py-3 px-6 text-center align-middle font-sans text-xs font-sans font-medium tracking-wide uppercase text-white shadow-md shadow-blue-500/20 transition-all hover:shadow-lg hover:shadow-blue-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none">Ver
        más...</button>
    ...
    <x-dialog-modal wire:model="open" maxWidth="5xl">
        ...
        <x-slot name="content">
            <div class="grid grid-cols-2 my-3">
                <p class="w-9/12 p-4 text-3xl font-sans leading-relaxed text-white rounded-r-full shadow-md h-min shadow-gray-600"
                    style="background-color: {{ $product->color }}">
                    Café tostado</p>
                <p class="w-full text-5xl font-sans leading-relaxed text-center text-black">{{ $product->name }}</p>
            </div>
            <div class="grid grid-cols-2">
                ...
                <div class="flex flex-col justify-between w-full ml-2 text-center text-black">
                    ...
                    <div>
                        ...
                        <div class="my-2 text-2xl text-left font-sans font-medium tracking-wide">
