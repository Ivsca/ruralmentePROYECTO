    ...
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div class="flex flex-col items-center md:items-start text-center md:text-left">
                ...
                <p class="text-lg italic text-white opacity-90 font-sans leading-relaxed max-w-xs">
                    Transformando vidas rurales a través del bienestar y el café con propósito.
                </p>
            </div>

            <div class="flex flex-col items-center md:items-start">
                <h3 class="text-xl font-sans font-medium tracking-wide mb-6 text-white">Redes Sociales</h3>
                <div class="space-y-4">
                    
                    <div class="flex items-center font-sans font-medium tracking-wide">
            ...
            <div class="flex flex-col items-center md:items-start">
                <h3 class="text-xl font-sans font-semibold mb-6 text-white">Nuestros Servicios</h3>
                <ul class="space-y-3">
                    <li class="flex items-center font-sans font-medium tracking-wide">
        ...
        <div class="border-t border-white border-opacity-30 mt-8 pt-8 max-w-6xl mx-auto">
            ...
            <div class="text-center">
                <p class="text-white opacity-80 text-sm font-sans font-medium tracking-wide">
